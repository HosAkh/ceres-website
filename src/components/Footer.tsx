          ...
          <div className="lg:col-span-1 flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4">
              <p className="font-nav text-[12px] tracking-[0.06em] uppercase text-slate-500 leading-relaxed max-w-[200px]">
                The new operating layer for Tier 1 Automotive supply chain planning.
              </p>

              <a className="flex items-center gap-2 group" href="https://www.linkedin.com/company/ceres-technology/posts/?feedView=all" target="_blank" rel="noopener noreferrer">
